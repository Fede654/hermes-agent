...
class HermesCLI:
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        # Otherwise treat the arg as the goal text. Parse an optional
        # trailing metric criterion ("..., pass_rate >= 0.9") so the goal
        # judge can short-circuit deterministically.
